...
import { KeyRound, Lock, Eye, EyeOff, CheckCircle2, AlertCircle, ArrowRight, Loader2 } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok || !data.success) {
        setErrorMessage(data.error || 'Password reset link is invalid or has expired.');
        return;
      }
        ...
        {isCompleted ? (
          <div style={{ textAlign: 'center', padding: '12px 0' }}>
            ...
            <p style={{ fontSize: '13px', color: '#64748b', lineHeight: 1.5, margin: '0 0 24px' }}>
              {successMessage || 'Your credentials have been updated. A confirmation notice was dispatched from password@fr8x.in.'}
            </p>
            <button
              type="button"
