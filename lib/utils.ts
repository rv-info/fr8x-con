export const CURRENCY_RATES: Record<string, { symbol: string; rateFromUSD: number; name: string }> = {
  ...
  AUD: { symbol: 'A$', rateFromUSD: 1.52, name: 'Australian Dollar' },
  CHF: { symbol: 'CHF ', rateFromUSD: 0.89, name: 'Swiss Franc' },
  HKD: { symbol: 'HK$', rateFromUSD: 7.82, name: 'Hong Kong Dollar' },
  NZD: { symbol: 'NZ$', rateFromUSD: 1.65, name: 'New Zealand Dollar' },
  SAR: { symbol: 'SAR ', rateFromUSD: 3.75, name: 'Saudi Riyal' },
  QAR: { symbol: 'QAR ', rateFromUSD: 3.64, name: 'Qatari Riyal' },
  KRW: { symbol: '₩', rateFromUSD: 1380, name: 'South Korean Won' },
  BRL: { symbol: 'R$', rateFromUSD: 5.60, name: 'Brazilian Real' },
  ZAR: { symbol: 'R ', rateFromUSD: 18.2, name: 'South African Rand' },
  MXN: { symbol: 'Mex$', rateFromUSD: 19.8, name: 'Mexican Peso' },
  SEK: { symbol: 'kr ', rateFromUSD: 10.5, name: 'Swedish Krona' },
  NOK: { symbol: 'kr ', rateFromUSD: 10.8, name: 'Norwegian Krone' },
  DKK: { symbol: 'kr ', rateFromUSD: 6.88, name: 'Danish Krone' },
  THB: { symbol: '฿', rateFromUSD: 36.5, name: 'Thai Baht' },
  IDR: { symbol: 'Rp ', rateFromUSD: 16200, name: 'Indonesian Rupiah' },
  MYR: { symbol: 'RM ', rateFromUSD: 4.68, name: 'Malaysian Ringgit' },
  PHP: { symbol: '₱', rateFromUSD: 58.2, name: 'Philippine Peso' },
  VND: { symbol: '₫', rateFromUSD: 25400, name: 'Vietnamese Dong' },
  TRY: { symbol: '₺', rateFromUSD: 34.1, name: 'Turkish Lira' },
  EGP: { symbol: 'E£', rateFromUSD: 48.5, name: 'Egyptian Pound' },
  KWD: { symbol: 'KD ', rateFromUSD: 0.31, name: 'Kuwaiti Dinar' },
  BHD: { symbol: 'BD ', rateFromUSD: 0.38, name: 'Bahraini Dinar' },
  OMR: { symbol: 'OMR ', rateFromUSD: 0.385, name: 'Omani Rial' },
  PLN: { symbol: 'zł', rateFromUSD: 3.98, name: 'Polish Zloty' },
  ILS: { symbol: '₪', rateFromUSD: 3.72, name: 'Israeli New Shekel' },
  CLP: { symbol: 'CLP$', rateFromUSD: 940, name: 'Chilean Peso' },
  COP: { symbol: 'COL$', rateFromUSD: 4150, name: 'Colombian Peso' },
  PEN: { symbol: 'S/.', rateFromUSD: 3.75, name: 'Peruvian Sol' },
  TWD: { symbol: 'NT$', rateFromUSD: 32.4, name: 'New Taiwan Dollar' },
  PKR: { symbol: '₨', rateFromUSD: 278.5, name: 'Pakistani Rupee' },
  BDT: { symbol: '৳', rateFromUSD: 119.5, name: 'Bangladeshi Taka' },
  LKR: { symbol: 'Rs ', rateFromUSD: 302.0, name: 'Sri Lankan Rupee' },
  RUB: { symbol: '₽', rateFromUSD: 92.5, name: 'Russian Ruble' },
};
