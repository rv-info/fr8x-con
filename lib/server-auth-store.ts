...
class ServerSecurityStore {
  ...
  public seedFoundationAccounts() {
    // Purge any legacy dummy accounts from memory
    const legacyDummies = ['u-arjun', 'u-sarah', 'u-kiran', 'u-elena', 'u-david', 'u-vikram', 'u-ananya', 'u-suspended-01', 'u-chen', 'u-vikas'];
    for (const d of legacyDummies) {
      this.users.delete(d);
      this.failedAttemptsByIdentifier.delete(d);
