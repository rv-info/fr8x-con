...
export function middleware(request: NextRequest) {
  ...
  response.headers.set(
    ...
    [
      "default-src 'self'",
      `connect-src 'self' ${appUrl} https://*.googleapis.com https://*.firebaseio.com https://*.firebaseapp.com wss://*.firebaseio.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://api.exchangerate-api.com`,
      "img-src 'self' data: blob: https://*.googleapis.com https://*.googleusercontent.com https://firebasestorage.googleapis.com https://storage.googleapis.com",
