// FR8X-CON Login Page — Light Theme & Crisp Outlines Container
"use client";
...
export default function LoginPage() {
  ...
  return (
    <main className="relative flex min-h-screen w-full items-center justify-center bg-[var(--fr8x-bg)] p-4 sm:p-6 transition-colors overflow-hidden">
      ...
      <div className="fixed top-4 right-4 sm:top-6 sm:right-6 z-50 flex flex-col items-end gap-2.5">
        ...
        <a
          ...
          className="inline-flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-[10px] sm:text-[11px] shadow-sm active:scale-[0.98] transition-all border border-emerald-500/40"
        ...
        <a
          ...
          className="inline-flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-white hover:bg-slate-100 text-slate-800 font-bold text-[10px] sm:text-[11px] shadow-sm active:scale-[0.98] transition-all border border-slate-300"
